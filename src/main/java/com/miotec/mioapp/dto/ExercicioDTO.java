    ...
    public static List<ExercicioDTO> create(List<Exercicio> exercicios) {
        ...
        exerciciosAgrupadosPorusuario.forEach((usuario, listaExercicios) -> {
            ...
            for (Exercicio exercicio : listaExercicios) {
                exercicioDTO.getDadosExercicio().add(new DadosExercicioDTO(exercicio.getData_execicio(),exercicio.getHorario(), exercicio.getNota_avaliativa(), exercicio.getId(), exercicio.getProtocolo().getId()));
            }
